    ...
    <main class="flex-1 flex overflow-hidden relative">
        ...
        <section id="tab-design" class="flex-1 flex overflow-hidden hidden">
            <aside id="designAside" class="mobile-sidebar w-80 border-r border-slate-855 bg-[#08090e] p-4 overflow-y-auto space-y-3 flex flex-col shrink-0">
                <div class="space-y-1">
                    <h2 class="text-xs font-bold text-fuchsia-400 uppercase tracking-wider font-mono">Recruitment Designer — Checkpoint 2</h2>
                    <p class="text-xs text-slate-400 leading-relaxed">Isi data bertahap. Semua proses di checkpoint ini berjalan lokal dengan cost Rp0.</p>
                </div>
                ...
                <div class="space-y-2">
                    <details class="group rounded-2xl border border-slate-800 bg-[#0b0d14]" open>
                        ...
                        <div class="px-3 pb-3 space-y-3 border-t border-slate-800/60 pt-3">
                            ...
                            <div class="space-y-2">
                                <label class="block text-xs font-semibold text-slate-400">Logo Perusahaan <span class="text-slate-600">(PNG/JPG, maks. 5 MB)</span></label>
                                <input id="designLogoInput" type="file" accept="image/png,image/jpeg,image/webp" class="hidden">
                                <input id="designLogoName" type="hidden"><input id="designPrimaryColor" type="hidden"><input id="designSecondaryColor" type="hidden">
                                ...
                                <div id="designLogoPreviewWrap" class="hidden rounded-xl border border-slate-800 bg-black/30 p-2 space-y-2">
                                    <div class="flex items-center gap-3"><div class="w-14 h-14 rounded-lg bg-white/90 p-1 flex items-center justify-center"><img id="designLogoPreview" class="max-w-full max-h-full object-contain"></div><div class="min-w-0 flex-1"><p id="designLogoFileName" class="text-xs font-bold text-white truncate"></p><button data-action="remove-design-logo" class="mt-1 text-[10px] font-bold text-rose-300 cursor-pointer">Hapus logo</button></div></div>
                                    <div class="grid grid-cols-2 gap-2"><div class="rounded-lg bg-[#0f111a] p-2"><div class="flex items-center gap-2"><span id="designPrimarySwatch" class="w-4 h-4 rounded-full bg-slate-700 border border-white/20"></span><span class="text-[9px] text-slate-500">Primary</span></div><p id="designPrimaryColorLabel" class="mt-1 text-[10px] font-mono text-slate-300">Belum dianalisis</p></div><div class="rounded-lg bg-[#0f111a] p-2"><div class="flex items-center gap-2"><span id="designSecondarySwatch" class="w-4 h-4 rounded-full bg-slate-500 border border-white/20"></span><span class="text-[9px] text-slate-500">Secondary</span></div><p id="designSecondaryColorLabel" class="mt-1 text-[10px] font-mono text-slate-300">Belum dianalisis</p></div></div>
                                </div>
                            </div>
                        </div>
                    </details>
                    ...
                    <details class="group rounded-2xl border border-slate-800 bg-[#0b0d14]">
                        <summary class="cursor-pointer list-none flex items-center justify-between p-3 text-xs font-black text-white"><span>3. Requirement & Jobdesk</span><span class="text-fuchsia-400 group-open:rotate-180 transition">⌄</span></summary>
                        <div class="px-3 pb-3 space-y-3 border-t border-slate-800/60 pt-3"><div class="space-y-2"><label class="block text-xs font-semibold text-slate-400">Requirement * <span class="text-slate-600">(satu per baris)</span></label><textarea id="designRequirements" class="w-full h-28 resize-y rounded-xl bg-[#0f111a] border border-slate-800 p-2.5 text-xs text-slate-200 focus:border-fuchsia-500 outline-none" placeholder="Minimal S1\nPengalaman 2 tahun\nKomunikasi baik"></textarea></div><div class="space-y-2"><label class="block text-xs font-semibold text-slate-400">Jobdesk <span class="text-slate-600">(satu per baris)</span></label><textarea id="designResponsibilities" class="w-full h-24 resize-y rounded-xl bg-[#0f111a] border border-slate-800 p-2.5 text-xs text-slate-200" placeholder="Mengelola proses rekrutmen\nMelakukan interview"></textarea></div></div>
                    </details>

                    <details class="group rounded-2xl border border-slate-800 bg-[#0b0d14]">
                        <summary class="cursor-pointer list-none flex items-center justify-between p-3 text-xs font-black text-white"><span>4. Benefit & Lamaran</span><span class="text-fuchsia-400 group-open:rotate-180 transition">⌄</span></summary>
                        <div class="px-3 pb-3 space-y-3 border-t border-slate-800/60 pt-3"><div class="space-y-2"><label class="block text-xs font-semibold text-slate-400">Benefit <span class="text-slate-600">(satu per baris)</span></label><textarea id="designBenefits" class="w-full h-20 resize-y rounded-xl bg-[#0f111a] border border-slate-800 p-2.5 text-xs text-slate-200" placeholder="BPJS\nTHR\nBonus kinerja"></textarea></div><div class="space-y-2"><label class="block text-xs font-semibold text-slate-400">Deadline</label><input id="designDeadline" type="date" class="w-full rounded-xl bg-[#0f111a] border border-slate-800 p-2.5 text-xs text-slate-200"></div><div class="space-y-2"><label class="block text-xs font-semibold text-slate-400">Email / WhatsApp Lamaran *</label><input id="designContact" class="w-full rounded-xl bg-[#0f111a] border border-slate-800 p-2.5 text-xs text-slate-200 focus:border-fuchsia-500 outline-none" placeholder="career@company.com"></div></div>
                    </details>

                    <details class="group rounded-2xl border border-slate-800 bg-[#0b0d14]">
                        <summary class="cursor-pointer list-none flex items-center justify-between p-3 text-xs font-black text-white"><span>5. Style & Output</span><span class="text-fuchsia-400 group-open:rotate-180 transition">⌄</span></summary>
                        <div class="px-3 pb-3 space-y-3 border-t border-slate-800/60 pt-3"><div class="grid grid-cols-2 gap-2"><div class="space-y-2"><label class="block text-xs font-semibold text-slate-400">CTA</label><select id="designCTA" class="w-full rounded-xl bg-[#0f111a] border border-slate-800 p-2.5 text-xs text-slate-200"><option>Apply Now</option><option>Join Our Team</option><option>Send Your CV</option><option>Apply Today</option></select></div><div class="space-y-2"><label class="block text-xs font-semibold text-slate-400">Rasio</label><select id="designRatio" class="w-full rounded-xl bg-[#0f111a] border border-slate-800 p-2.5 text-xs text-slate-200"><option>4:5</option><option>1:1</option><option>9:16</option><option>A4 Portrait</option></select></div></div><div class="space-y-2"><label class="block text-xs font-semibold text-slate-400">Gaya Visual</label><select id="designStyle" class="w-full rounded-xl bg-[#0f111a] border border-slate-800 p-2.5 text-xs text-slate-200"><option>Modern Corporate</option><option>Minimalist Professional</option><option>Bold Recruitment</option><option>Creative Agency</option><option>Luxury Corporate</option><option>Friendly Startup</option></select></div><div class="space-y-2"><label class="block text-xs font-semibold text-slate-400">Catatan Tambahan</label><textarea id="designExtraNotes" class="w-full h-20 resize-y rounded-xl bg-[#0f111a] border border-slate-800 p-2.5 text-xs text-slate-200" placeholder="Beri ruang untuk QR, gunakan nuansa profesional..."></textarea></div></div>
                    </details>
                </div>

                <button data-action="generate-design-recruitment" class="w-full py-3 rounded-xl bg-fuchsia-600 hover:bg-fuchsia-500 text-white text-xs font-black uppercase tracking-wider cursor-pointer">Generate Recruitment Prompt</button>
            ...
            <section class="flex-1 overflow-y-auto p-4 md:p-6 custom-scrollbar">
                <div class="max-w-6xl mx-auto space-y-5">
                    <div class="rounded-3xl border border-fuchsia-500/15 bg-gradient-to-br from-fuchsia-500/10 via-slate-950/50 to-[#08090e] p-5 md:p-6 shadow-2xl"><p class="text-[10px] font-mono font-bold text-fuchsia-300 uppercase tracking-[0.2em]">Design Studio DNA Engine — Checkpoint 2</p><h2 class="mt-2 text-xl md:text-2xl font-black text-white">Recruitment Designer</h2><p class="mt-2 text-xs md:text-sm text-slate-400 max-w-3xl leading-relaxed">Upload logo, analisis warna otomatis di browser, isi data lowongan, lalu hasilkan prompt poster yang siap dipakai. Tidak ada API berbayar.</p></div>

                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3"><div class="rounded-2xl border border-slate-800 bg-[#08090e] p-4"><p class="text-[10px] text-fuchsia-300 font-black uppercase">Cost</p><p class="mt-1 text-lg font-black text-white">Rp0</p><p class="text-[10px] text-slate-500">Semua diproses lokal</p></div><div class="rounded-2xl border border-slate-800 bg-[#08090e] p-4"><p class="text-[10px] text-fuchsia-300 font-black uppercase">Brand</p><p class="mt-1 text-lg font-black text-white">Auto Color</p><p class="text-[10px] text-slate-500">Dibaca dari logo</p></div><div class="rounded-2xl border border-slate-800 bg-[#08090e] p-4"><p class="text-[10px] text-fuchsia-300 font-black uppercase">Output</p><p class="mt-1 text-lg font-black text-white">Prompt Siap Copy</p><p class="text-[10px] text-slate-500">Gemini / Imagen / Firefly</p></div></div>

                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                        <div class="lg:col-span-1 rounded-3xl border border-amber-500/20 bg-amber-500/5 p-5 space-y-4"><div class="flex items-center justify-between"><div><p class="text-[10px] font-black text-amber-300 uppercase tracking-wider">Smart Recommendation</p><h3 class="mt-1 text-sm font-black text-white">Saran desain gratis</h3></div><span class="text-2xl">💡</span></div><div class="space-y-3 text-xs"><div><p class="text-[10px] uppercase text-slate-500 font-bold">Style</p><p id="designRecommendationStyle" class="mt-1 text-slate-200 font-bold">Modern Corporate</p></div><div><p class="text-[10px] uppercase text-slate-500 font-bold">Hero Visual</p><p id="designRecommendationVisual" class="mt-1 text-slate-300 leading-relaxed">professional employee or role-related workplace visual</p></div><div><p class="text-[10px] uppercase text-slate-500 font-bold">Warna Aksen</p><div class="mt-1 flex items-center gap-2"><span id="designRecommendationSwatch" class="w-5 h-5 rounded-full bg-fuchsia-600 border border-white/20"></span><span id="designRecommendationColor" class="font-mono text-slate-300">#C026D3</span></div></div><div><p class="text-[10px] uppercase text-slate-500 font-bold">Benefit yang biasa relevan</p><p id="designRecommendationBenefit" class="mt-1 text-slate-300 leading-relaxed">Tambahkan benefit paling menarik untuk kandidat</p></div></div><button data-action="apply-design-recommendation" class="w-full py-2 rounded-xl border border-amber-500/30 bg-amber-500/10 text-[10px] font-black text-amber-200 cursor-pointer">Terapkan Saran Style & Warna</button></div>

                        <div class="lg:col-span-2 space-y-4"><div id="designOutputEmpty" class="rounded-3xl border border-dashed border-slate-800 bg-[#08090e] p-10 text-center"><div class="text-4xl mb-3">🎨</div><h3 class="text-sm font-bold text-slate-300">Belum ada prompt recruitment.</h3><p class="text-xs text-slate-500 mt-1">Lengkapi minimal nama perusahaan, posisi, requirement, dan kontak.</p></div><div id="designOutputPanel" class="hidden rounded-3xl border border-fuchsia-500/20 bg-[#08090e] p-5 md:p-6"><div class="flex flex-wrap items-center justify-between gap-3 mb-4"><div><p class="text-[10px] font-black text-fuchsia-300 uppercase tracking-wider">Output Preview</p><h3 class="mt-1 text-sm font-black text-white">Recruitment Poster Prompt</h3><p class="text-[10px] text-slate-500 mt-1">Sudah termasuk brand color, layout, safe margin, dan anti-hallucination rules.</p></div><button data-action="copy-design-prompt" class="px-4 py-2 rounded-xl bg-fuchsia-600 hover:bg-fuchsia-500 text-white text-xs font-black cursor-pointer">Copy Prompt</button></div><pre id="designPromptOutput" class="max-h-[520px] overflow-y-auto whitespace-pre-wrap rounded-2xl bg-black/40 border border-slate-800 p-4 text-xs leading-relaxed text-slate-300 font-mono select-text"></pre></div></div>
                    </div>
                </div>
            </section>
        </section>
