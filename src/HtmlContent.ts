                ...
                <div class="max-w-7xl mx-auto space-y-5">
                    ...
                    <div class="grid grid-cols-1 xl:grid-cols-[minmax(340px,0.9fr)_minmax(420px,1.1fr)] gap-5">
                        <div class="space-y-4">
                            ...
                            <div id="designOutputEmpty" class="rounded-3xl border border-dashed border-slate-800 bg-[#08090e] p-8 text-center"><div class="text-4xl mb-3">📝</div><h3 class="text-sm font-bold text-slate-300">Prompt belum dibuat.</h3><p class="text-xs text-slate-500 mt-1">Live poster tetap bisa dilihat sambil mengisi form.</p></div>
